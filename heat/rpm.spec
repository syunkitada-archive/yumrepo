...
%dir %attr(0755, root, root) /etc/%{name}/environment.d
%dir %attr(0755, root, root) /etc/%{name}/templates
%config(noreplace) %attr(-, root, root) /etc/%{name}/*
%config(noreplace) %attr(-, root, root) /etc/%{name}/environment.d/*
%config(noreplace) %attr(-, root, root) /etc/%{name}/templates/*
